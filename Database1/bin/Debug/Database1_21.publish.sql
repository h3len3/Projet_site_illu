...
GO
PRINT N'Création de Table [dbo].[OrderProduct]...';
...
CREATE TABLE [dbo].[OrderProduct] (
    ...
    [Id_Order]        INT NULL,
    [Id_Product]      INT NULL,
    PRIMARY KEY CLUSTERED ([Id_OrderProduct] ASC)
);
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_OrderProduct_Order]...';


GO
ALTER TABLE [dbo].[OrderProduct]
    ADD CONSTRAINT [FK_OrderProduct_Order] FOREIGN KEY ([Id_Order]) REFERENCES [dbo].[Order] ([Id_Order]);


GO
PRINT N'Création de Clé étrangère [dbo].[FK_OrderProduct_Product]...';


GO
ALTER TABLE [dbo].[OrderProduct]
    ADD CONSTRAINT [FK_OrderProduct_Product] FOREIGN KEY ([Id_Product]) REFERENCES [dbo].[Product] ([Id_Product]);
...
AS
		...
		UPDATE [Category] 
			...
			WHERE [Id_Category] = @id_category
GO
PRINT N'Création de Procédure [dbo].[SP_Order_Delete]...';
...
GO
PRINT N'Création de Procédure [dbo].[SP_Order_GetAll]...';
...
CREATE PROCEDURE [dbo].[SP_Order_GetAll]
	AS
	   SELECT [Id_Order],
		   ...
		   FROM [Order]
GO
PRINT N'Création de Procédure [dbo].[SP_Order_GetById]...';
...
AS
	SELECT [Id_Order],
		...
		WHERE [Id_Order] = @id_order
GO
PRINT N'Création de Procédure [dbo].[SP_Order_Insert]...';
...
AS
	INSERT INTO [Order] ([Date_Order])
		...
		VALUES (@date_order)
GO
PRINT N'Création de Procédure [dbo].[SP_Order_Update]...';
...
AS
	UPDATE [Order] 
		...
		WHERE [Id_Order] = @id_order
GO
PRINT N'Création de Procédure [dbo].[SP_OrderProduct_Insert]...';
